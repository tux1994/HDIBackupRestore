...
```
On the deployed application on BTP replace the dot with underscore and add the following variables to the User-Provided Variables on the srv-Application:
```
